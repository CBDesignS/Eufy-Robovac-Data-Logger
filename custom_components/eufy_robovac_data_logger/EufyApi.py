        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(
                ...
                if response.status == 200:
                    ...
                    # Try to get user_center_id from different possible locations
                    user_center_id = None
                    ...
                    # Check in data field
                        ...
                        # Move data fields to top level for compatibility
            ...
            async with session.post(
                ...
                if response.status == 200:
                    ...
                    if res.get('code') == 0 or res.get('res_code') == 1:
                        ...
                        # Check data.devices format (current API)
                        data = res.get('data', {})
